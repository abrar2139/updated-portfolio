...
export const Footercomponent = () => {
  return (
   ...
   <h1 className='text-medium sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl text-center justify-center flex flex-wrap'>© Copyright <span className='hover:text-purple-600 px-1 transition-colors duration-300 ease-in-out'>AbDevelopers.</span> All Rights Reserved</h1>
